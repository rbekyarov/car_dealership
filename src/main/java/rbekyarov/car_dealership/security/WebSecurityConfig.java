package rbekyarov.car_dealership.security;
...
import rbekyarov.car_dealership.security.jwt.AuthEntryPointJwt;
import rbekyarov.car_dealership.security.jwt.AuthTokenFilter;
    ...
    http.csrf(csrf -> csrf.disable())
        ...
        .authorizeHttpRequests(auth -> 
          auth.requestMatchers(new AntPathRequestMatcher("/**")).permitAll()
                  .requestMatchers(new AntPathRequestMatcher("/api/enum/**")).permitAll()
              .anyRequest().authenticated()
        );
